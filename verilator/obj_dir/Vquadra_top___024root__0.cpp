        ...
        vlSelfRef.quadra_top__DOT__u_quadra__DOT__y_r 
            = (0x00ffffffU & ((vlSelfRef.quadra_top__DOT__u_quadra__DOT__t0_r2 
                               + (vlSelfRef.quadra_top__DOT__u_quadra__DOT__t1_r2 
                                  + (0x3fffffffU & 
                                     VL_EXTENDS_II(30,29, vlSelfRef.quadra_top__DOT__u_quadra__DOT__t2_r2)))) 
                              >> 5U));
        vlSelfRef.quadra_top__DOT__u_quadra__DOT__t1_r2 
            = (0x3fffffffU & VL_SHIFTRS_III(30,30,32, 
                                            (0x3fffffffU 
                                             & VL_MULS_III(30, 
                                                           (0x3fffffffU 
                                                            & VL_EXTENDS_II(30,19, vlSelfRef.quadra_top__DOT__u_quadra__DOT__b_r1)), 
                                                           (0x3fffffffU 
                                                            & VL_EXTENDS_II(30,18, vlSelfRef.quadra_top__DOT__u_quadra__DOT__x2_r1)))), 6U));
        vlSelfRef.quadra_top__DOT__u_quadra__DOT__t2_r2 
            = (0x1fffffffU & VL_SHIFTRS_III(29,29,32, 
                                            (0x1fffffffU 
                                             & VL_MULS_III(29, 
                                                           (0x1fffffffU 
                                                            & VL_EXTENDS_II(29,13, (IData)(vlSelfRef.quadra_top__DOT__u_quadra__DOT__c_r1))), 
                                                           (0x1fffffffU 
                                                            & VL_EXTENDS_II(29,25, vlSelfRef.quadra_top__DOT__u_quadra__DOT__sq_r1)))), 8U));
...
void Vquadra_top___024root___eval(Vquadra_top___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00002710U < __VicoIterCount)))) {
            ...
            Vquadra_top___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/jakub/Desktop/Interview/3_code/rtl-model/quadra_top.sv", 7, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 10000 tries");
        }
    ...
    do {
...
#endif
            VL_FATAL_MT("/home/jakub/Desktop/Interview/3_code/rtl-model/quadra_top.sv", 7, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 10000 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VactIterCount)))) {
                ...
                Vquadra_top___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("/home/jakub/Desktop/Interview/3_code/rtl-model/quadra_top.sv", 7, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 10000 tries");
            }
